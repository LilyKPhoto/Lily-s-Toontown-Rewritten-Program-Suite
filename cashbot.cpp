/*-----------------------------------------------------------------------------
 Function Name: cashbotCalc
 Function Return Type: void
 Parameters: none
 Function Description: This function asks the user for the Cog's name and its
 suit level. It will then output the number and type of Mints needed
...
void cashbotCalc() {
	...
	cout << "Take all of the calculations here with a slight grain of salt." << endl;
	cout << "Each of the Cashbot Mints have 20 different floors, which means that" << endl;
	cout << "there is no way to know how many Cogbucks you'll get until you're in the mint." << endl;
	cout << "Because of the range of Cogbucks in each mint, you may need to do a "
		"building or two after the mint(s)." << endl;
	cout << "Also, I can't account for every possible combination of Mints." << endl;
	...
	cout << "\nYour Cog Disguise needs " << neededCogbucks << " Cogbucks.\n"
		<< endl; // display the neededCogbucks value

	// Figuring out what mints are needed based on Stock Option requirements //
